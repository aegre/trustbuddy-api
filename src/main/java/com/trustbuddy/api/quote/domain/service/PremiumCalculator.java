...
public class PremiumCalculator {
	...
	PremiumCalculator(BasePremiumResolver basePremiumResolver, List<PremiumMultiplier> multipliers) {
		this.basePremiumResolver = Objects.requireNonNull(basePremiumResolver, "basePremiumResolver");
